...
Present this prompt for them to use in the Claude browser extension:

> Xのあなたのプロフィールページを開いた状態で、Claude拡張に以下のプロンプトを貼ってください：
>
> ```
> このページに表示されている私のツイート（リポスト・返信を除く、自分のオリジナル投稿のみ）を最大20件抽出して、以下のMarkdown形式で出力してください。
>
> ---
> ### ツイート1
> **本文:** [ツイート本文をそのまま。改行も保持]
> **投稿日時:** [表示されている日時]
> **いいね:** [数字] / **RP:** [数字] / **ブックマーク:** [数字] / **インプ:** [数字（見えるもののみ）]
> ---
>
> ※ 絵文字・ハッシュタグ・URLは省略せず残してください
> ※ スレッド投稿の場合は1ツイートとしてまとめず、別々に記録してください
> ※ 数字が見えないものは「-」と記入
> ```
>
